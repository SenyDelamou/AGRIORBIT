...
const translations = {
    fr: {
        ...
        subscription_desc: 'Gérez votre simulation d’abonnement.',
        subscription_desc_standard: 'Accédez à l’essentiel. Passez en Premium pour débloquer les modules avancés.',
        subscription_desc_premium: 'Simulation Premium activée.',
        logout: 'Déconnexion',
        change: 'Modifier',
        ...
        premium_standard: 'Plan Découverte',
        premium_premium: 'Plan Orbit Premium',
        premium_upgrade_cta: 'Passer en Premium',
        premium_manage_cta: 'Gérer mon abonnement',
        premium_downgrade_cta: 'Revenir au plan Découverte',
        premium_current_plan: 'Plan actuel',
        premium_next_renewal: 'Renouvellement',
        premium_not_applicable: 'Non défini',
        premium_upgrade_toast: 'Bienvenue dans Agri Orbit Premium — simulation activée.',
        premium_downgrade_toast: 'Vous êtes repassé sur le plan Découverte.',
        premium_simulation_hint: 'Simulation locale — aucun paiement n’est effectué.',
        premium_locked_label: 'Fonctionnalité Premium',
        premium_locked_explorer_title: 'Débloquez l’explorateur multi-spectral',
        premium_locked_explorer_desc: 'Accédez au scan satellite, aux rapports NDVI et aux recommandations intelligentes en temps réel.',
        premium_locked_analytics_title: 'Activez les analyses prédictives',
        premium_locked_analytics_desc: 'Obtenez la chronologie des alertes, les projections de rendement et les exports automatisés.',
        premium_feature_list_title: 'Avantages Premium',
        premium_feature_point_1: 'Analyses multi-spectrales illimitées',
    ...
    en: {
        ...
        subscription_desc: 'Manage your subscription simulation.',
        subscription_desc_standard: 'Access the essentials. Upgrade to Premium to unlock advanced modules.',
        subscription_desc_premium: 'Premium simulation enabled.',
        logout: 'Logout',
        change: 'Edit',
        ...
        premium_badge: 'Premium',
        premium_standard: 'Discovery Plan',
        premium_premium: 'Orbit Premium Plan',
        premium_upgrade_cta: 'Upgrade to Premium',
        premium_manage_cta: 'Manage subscription',
        premium_downgrade_cta: 'Return to Discovery plan',
        premium_current_plan: 'Current plan',
        premium_next_renewal: 'Renewal',
        premium_not_applicable: 'N/A',
        premium_upgrade_toast: 'Welcome to Agri Orbit Premium — simulation activated.',
        premium_downgrade_toast: 'You are back on the Discovery plan.',
        premium_simulation_hint: 'Local simulation — no payment is processed.',
        premium_locked_label: 'Premium Feature',
        premium_locked_explorer_title: 'Unlock the multi-spectral explorer',
        premium_locked_explorer_desc: 'Access satellite scans, NDVI reports, and real-time recommendations.',
        premium_locked_analytics_title: 'Activate predictive analytics',
        premium_locked_analytics_desc: 'Get the alert timeline, yield projections, and automated exports.',
        premium_feature_list_title: 'Premium Benefits',
        premium_feature_point_1: 'Unlimited multi-spectral analyses',
